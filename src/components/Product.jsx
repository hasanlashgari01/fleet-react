function Product({ title, subTitle, price, offPrice, startDate, endDate, score }) {
    return (
        <div className="group w-[267px] mx-auto bg-neutral-8 dark:bg-neutral-2 rounded-2xl overflow-hidden">
            ...
            <div className="p-5">
                <div className="flex justify-between">
                    <div className="w-[151px]">
                        <h3 className="text-neutral-1 dark:text-neutral-8 font-PoppinsMedium text-base line-clamp-1">{title}</h3>
                        <h4 className="text-neutral-3 dark:text-neutral-6 font-PoppinsRegular text-xs/5 line-clamp-1">{subTitle}</h4>
                    </div>
