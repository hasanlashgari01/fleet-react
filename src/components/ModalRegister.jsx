    ...
    return createPortal(
        ...
        >
            ...
            <div className={`modal__wrapper ${isModalRegister ? "md:-translate-y-1/2" : "translate-y-full"}`}>
                ...
                <h1 className="text-neutral-1 font-DMSansBold text-center text-[40px]/[48px]">Sign up on Fleet</h1>
                ...
                <div className="my-4 lg:my-8 flex justify-center gap-x-3">
                    ...
                    <span className="flex items-center bg-neutral-1 text-neutral-8 font-DMSansBold leading-4 py-4 px-6 gap-x-3 rounded-full">
                        <svg className="w-4 h-4">
                            <use href="#apple"></use>
                        </svg>
                        Apple
                ...
                <div className="mt-4 lg:mt-8 font-PoppinsRegular text-center text-xs/5 md:text-sm">
