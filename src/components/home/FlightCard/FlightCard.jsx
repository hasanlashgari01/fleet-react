...
const FlightCard = () => {
    return (
        <div className="flex flex-col lg:flex-row gap-y-3 gap-x-8">
            <div className="text-center flex-1 lg:max-w-[160px] py-4 bg-neutral-7 h-[59px] rounded-lg">Emirates</div>
            <div className="flex flex-1 justify-between items-center">
                <FlightInfo location="AKL" time="6:45" />
                <div className="flex flex-col gap-y-2">
                    <span className="inline-block w-full h-[1px] bg-neutral-6 rounded-full"></span>
