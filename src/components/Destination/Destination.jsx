...
function Destination({ title }) {
    return (
        <div className="flex flex-col flex-initial xs:flex-1 sm:flex-initial justify-center items-center w-min space-y-[21px]">
            ...
            <div className="w-full pl-4 pr-1">
                ...
                <p className="mt-2 text-neutral-4 font-PoppinsRegular text-xs/5 line-clamp-1">Car rentals in 86 pickup locations</p>
            </div>
        </div>
    );
}
