function Hero() {
    return (
        <div className="relative h-screen mx-4 lg:mx-10 2xl:mx-20 rounded-3xl overflow-hidden">
            ...
            <div id="hero" className="bg-[17%] -mt-56 lg:mt-0 bg-248 xs:bg-175 sm:bg-135 lg:bg-cover bg-no-repeat h-full z-0"></div>
        </div>
    );
}
