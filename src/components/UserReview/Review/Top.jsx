...
const Top = () => {
    return (
        <div>
            <h3 className="text-neutral-2 font-PoppinsMedium lg:font-PoppinsSemiBold text-base lg:text-2xl">Add a review</h3>
            <div className="mt-2 flex flex-col 2xl:flex-row 2xl:justify-between 2xl:items-center gap-y-2">
                <div className="text-sm">
                    ...
                    <span className="ml-2 text-neutral-2 font-PoppinsMedium">All Access Pass</span>
                </div>
