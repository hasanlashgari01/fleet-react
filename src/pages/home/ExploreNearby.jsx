...
function ExploreNearby() {
    ...
    return (
        <div className="container py-16 lg:py-28 bg-neutral-7 dark:bg-neutral-1 dark:border-2 border-neutral-2 rounded-3xl">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 my-10 lg:mt-20 lg:mb-0 2xl: gap-x-8 gap-y-16">
                {data.map((item) => (
                    <div key={item.id} className="flex flex-col items-center p-2 pb-6 bg-neutral-8 dark:bg-neutral-2 rounded-2xl">
                        ...
                        <h3 className="text-neutral-2 dark:text-neutral-8 font-PoppinsMedium text-base">{item.title}</h3>
